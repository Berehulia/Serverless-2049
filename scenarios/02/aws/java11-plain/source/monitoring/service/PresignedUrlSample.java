...
import com.monitoring.auth.AWS4SignerBase;
import com.monitoring.auth.AWS4SignerForQueryParameterAuth;
...
public class PresignedUrlSample {
     ...
     */
    public static String getPresignedUrlToS3Object(String regionName, String bucketName, String key,
                                                   int expiresIn,
        ...
        try {
            if (regionName.equals("us-east-1")) {
                endpointUrl = new URL("https://s3.amazonaws.com/" + bucketName + "/" + key);
            } else {
